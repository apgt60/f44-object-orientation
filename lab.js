...
console.log("favoriteThings:", favoriteThings)

/*
  After you've made your object, use bracket or dot notation to add another key 
  named 'car' with the value being your favorite car and then another key named 
...
console.log("vars:", color, make, model, year)
...
console.log("greeting:",greeting(p7obj))
...
console.log("totalPopulation(p8obj):", totalPopulation(p8obj))
...
console.log("ingredients:", ingredients({carb: 'cc', fat:'ff', protein:'pp'}))
...
let p12cat = new Cat('Olga', 2, 'white')
console.log("p12cat:", p12cat)
console.log("p12cat.name:", p12cat.name)
...
const p13wizard = new Wizard('Gandalf', 999, 'Healing')
console.log("p13wizard:", p13wizard)
p13wizard.castSpell()
...
//Code Here
let phone1 = new Phone("Apple", "iPhone 14", 256, "Gray", 900)
let phone2 = new Phone("Samsung", "Galaxy F34", 128, "Black", 1000)
let phone3 = new Phone("Google", "Pixel 8", 512, "Porcelain", 1100)
console.log("p14 phones:", [phone1, phone2, phone3])
...
/*
  ...
  Note: We did not cover the spread operator in class. We do not expect you to 
  know how to use it. Challenge yourself by going online and researching what the 
...
console.log("helensInfo:", helensInfo)
...
let myFirstVehicle = new Vehicle(7, 'White', 30000)
console.log("myFirstVehicle init:", myFirstVehicle)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'Red', 5000, "Honda", false)
...
console.log('myFirstMotorcycle-moved:', myFirstMotorcycle)
...
//Code Here
let myFirstBoat = new Boat(5, "Blue", 2000, "Destiny", "Yacht", false)
console.log("myFirstBoat init:", myFirstBoat)
...
//Code Here
console.log("myFirstBoat-after-performMaintenance:", myFirstBoat)

/*-----------------------------------------------------------------------------------*/
/*---------------------------------END OF LAB----------------------------------------*/
/*-----------------------------------------------------------------------------------*/

//Amit is testing stuff
console.log("--Amit testing")
let {name} = myFirstBoat
//Change the name var
name = "Kismet"
//Does the original object change?
console.log("destructured name var:", name)
console.log("original myFirstBoat:", myFirstBoat)

//keys in obj
for(key in myFirstBoat){
  console.log(`${key}:${myFirstBoat[key]}`)
}